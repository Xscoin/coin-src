...
unsigned int nStakeTargetSpacing = 2.30 * 60; // 5-minute stakes spacing
int64_t nTargetSpacing = 2.30 * 60;  // Same as the above
...
static const int64_t nTargetTimespan = 2.30 * 15 * 60;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in XSCOIN
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // XSCOIN: check proof-of-stake block signature
...
bool CBlock::AcceptBlock()
{
    ...
    if (CheckpointsMode == Checkpoints::XSCISORY && !cpSatisfies)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "XSCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The XSC Today.. We are in the end game NOW... ";
        CTransaction txNew;
        txNew.nTime = 1544296113;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1544296113;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 538159 : 74303;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xc10c32f4a5cab0e35042e6bc35cdbaf04a0ff9498e749532f870f6348563d6b4"));
